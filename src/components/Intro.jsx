...
function Intro(){
    ...
    <div className="px-4 py-5 my-5 text-center">
      ...
      <h2>I aspire to solve real world problems through code.</h2>
      <ul id="menu">
    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div className="col-lg-6">
          ...
          <p className="lead">As someone who's completed 2 years as a full time developer, I bring the energy and curiosity that you need in your venture. To know more about me and what I am capable of, continue reading.</p>
        </div>
      </div>
    </div>
    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <div className="col-lg-6">
          ...
          <p className="lead">As someone who's fascinated by Blockchain technology, I spend time and effort understanding the tech and developing projects around it.</p>
          <div className="row-md-6">
            <div className="h-100 p-5 border rounded-3">
              <h4>Tools/ Frameworks I am proficient in:</h4>
              <p><ul>
                <li>Ganache</li>
                <li>Metamask</li>
                <li>ReactJS</li>
                <li>Truffle console</li>
                <li>Smart Contracts using Solidity</li>
                <li>ERC20 protocol</li>
              </ul></p>
            </div>
          </div>           
        </div>
